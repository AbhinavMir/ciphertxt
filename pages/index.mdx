...
Heavily inspired by [MIT 6.5620/6.875/18.425](http://mit6875.org/)
...
4. [Goldreich-Goldwasser-Micali PRF Construction and IND-CPA Encryption](/introduction/prg-to-prf) - Constructing PRFs from PRGs. Using PRFs for IND-CPA symmetric encryption.

5. [MACs, and Chosen Ciphertext Secure Encryption](/introduction/macs-cca) - Authentication via identification protocols. Message authentication codes. IND-CCA secure encryption. 
...
20. [Secret-Sharing and Secure Multiparty Computation - Secret sharing. Extending two-party computation to multiparty - detailed notes](./mpc)
...
˜
1. [Introduction and History of Zero-Knowledge Proofs](/zk/history) - Background and history of ZK proofs.

2. [A more mathematical introduction to ZK proofs](/zk/math).

2. [Overview of Modern SNARK Constructions](/zk/snark) - High-level overview of modern succinct non-interactive arguments of knowledge (SNARKs).

3. Practical ZK - SNARK vs STARK, practical examples: bulletproof, Plonk, Marlin. ZCash, Monero, ZK Rollups.
...
9. Killian's Protocol and Linear PCPs - Killian's protocol. Linear probabilistically checkable proofs (PCPs).
